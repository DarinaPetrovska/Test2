...
<header class="header">
	<div class="container">
        <?php if ( ot_get_option( 'logo' ) ) : $logo = ot_get_option( 'logo' ); ?><a href="/" class="logo"><img src="<?php echo ( $logo );?>" alt=""></a><?php endif; ?>
         ...
         <div class="visit"> 
            <?php if ( ot_get_option( 'besog_siden_url' ) ) : $besog_siden_url = ot_get_option( 'besog_siden_url' ); ?><a href="<?php echo ( $besog_siden_url );?>"><?php endif; ?>           
            <?php if ( ot_get_option( 'besog_siden_text' ) ) : $besog_siden_text = ot_get_option( 'besog_siden_text' ); ?><?php echo ( $besog_siden_text );?><?php endif; ?>
            </a>
         </div>         
	</div>
</header>
...
<div class="prestashop_fixed">
            ...
            <?php if ( ot_get_option( 'partner_text' ) ) : $partner_text = ot_get_option( 'partner_text' ); ?><span><?php echo ( $partner_text );?></span><?php endif; ?>
            </a></div>
    <div class="pencil">
