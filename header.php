...
<div class="load_page_wrap">
	<div class="container">
		<section>
         <?php if ( ot_get_option( 'load_url' ) ) : $load_url = ot_get_option( 'load_url' ); ?><a href="<?php echo ( $load_url );?>" class="load_logo"><?php endif; ?>
		      <?php if ( ot_get_option( 'load_logo' ) ) : $load_logo = ot_get_option( 'load_logo' ); ?><img src="<?php echo ( $load_logo );?>" alt=""><?php endif; ?></a>
